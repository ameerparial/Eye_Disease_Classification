...
def scaleImage(path):
  eyedetect=cv2.CascadeClassifier('https://github.com/anaustinbeing/haar-cascade-files/blob/master/haarcascade_eye.xml')
  try:
    image = path
...
@st.cache
def load_model(): 
    model = joblib.load(urllib3.request.urlopen('https://github.com/ameerparial/files/blob/main/random_forest.joblib'))
    return model
